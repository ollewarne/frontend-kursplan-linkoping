class Summative extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
         <section class="summativ mobileFirst">
            <div class="kunskap-wrap">
                ...
                <p class="sum-text">Summativ bedömning utvärderar studerandes kunskaper och färdigheter retroaktivt för att sammanfatta vad
        ...
        <section class="formativ mobileFirst">
                ...
                <p class="sum-text">Formativ bedömning utvärderar studerandes kunskaper och färdigheter löpande under kursens interaktiva
            ...
            <p class="sum-text">Formativ bedömning är ett komplement till summativ bedömning och tillämpas enbart till fördel för studerande.
